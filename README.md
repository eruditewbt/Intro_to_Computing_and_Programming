...
- Programming:
  ...
  - language survey across Python, JavaScript, C, HTML/CSS, SQL
- Computing breadth:
  - networking basics
...
- explain what a computer is in plain language
- set up their own device for coding
- use a terminal confidently
- configure an editor
- use Git for real project history
